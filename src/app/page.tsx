...
const accinVortexPlayers: Player[] = [
    { id: 1, number: 1, name: "JORGE SEGURA", role: "PITCHER", placeOfBirth: "GUATEMALA" },
    { id: 2, number: 2, name: "JUAN DIEGO MORALES", role: "PITCHER", placeOfBirth: "GUATEMALA" },
    { id: 3, number: 3, name: "JUAN JOSÉ PEPE", role: "PITCHER", placeOfBirth: "ARGENTINA" },
    { id: 4, number: 14, name: "LEONARDO BRESS", role: "PITCHER", placeOfBirth: "ARGENTINA" },
    { id: 5, number: 27, name: "LUIS TORREJÓN", role: "CATCHER", placeOfBirth: "ARGENTINA" },
    { id: 6, number: 4, name: "FAUSTO SIVIERO", role: "CATCHER", placeOfBirth: "ARGENTINA" },
    { id: 7, number: 52, name: "MANUEL GODOY", role: "INFIELDER", placeOfBirth: "ARGENTINA" },
    ...
    { id: 15, number: 31, name: "LAUTARO GARCÍA", role: "OUTFIELDER", placeOfBirth: "ARGENTINA" },
    { id: 16, number: 32, name: "JOSÉ DORANTES", role: "UTILITY", placeOfBirth: "VENEZUELA" },
    { id: 17, number: 82, name: "GUSTAVO GODOY", role: "COACH", placeOfBirth: "ARGENTINA" },
    { id: 18, number: 18, name: "ÁLVARO QUISPE", role: "COACH", placeOfBirth: "ARGENTINA" },
    { id: 19, number: 33, name: "CHRISTIAN RIAL", role: "TEAM PRINCIPAL", placeOfBirth: "ARGENTINA" },
    { id: 20, number: 6, name: "IVÁN FURMAN", role: "HEAD COACH", placeOfBirth: "ARGENTINA" },
    { id: 21, number: 22, name: "MARIO PORCO", role: "HEAD COACH", placeOfBirth: "ARGENTINA" },
];
